...
public:
    ...
    */
    ...
    /*
      set the target altitude to the specified altitude in cm above MSL.
     */
    void set_target_altitude_amsl_cm(const int32_t target_amsl_cm) { _target_amsl_cm = target_amsl_cm; }
    ...
    */
    ...
    int32_t get_terrain_alt_cm(void) {return _target_terrain_alt_cm;};
