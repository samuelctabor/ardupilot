...
float Plane::relative_ground_altitude(bool use_rangefinder_if_available)
{
   ...
   if (use_rangefinder_if_available && quadplane.in_vtol_land_final() &&
    ...
    if (quadplane.in_vtol_land_descent() &&
        ...
        // height
        return altitudePlanner.get_height_above_target(current_loc, next_WP_loc);
    }
...
{
    return current_loc.alt - (altitudePlanner.get_mission_alt_offset()*100);
}
...
{
    return (relative_altitude - altitudePlanner.get_mission_alt_offset())*100;
}
